...
export const postPreInscripciones = async (req) => {
  ...
  const informe = await dataBase.query(`
    INSERT INTO pre_inscripcion_estudiante(nombre, a_paterno, a_materno, ci, direccion, telefono, email)
    VALUES($1, $2, $3, $4, $5, $6, $7)
    RETURNING *
    `, [nombre, apellidoPaterno, apellidoMaterno, ci, direccion, telefono, email])
